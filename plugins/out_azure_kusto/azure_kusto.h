...
typedef enum {
    ...
    FLB_AZURE_CLOUD_GERMAN          /* AzureGermanCloud */
} flb_azure_cloud_type;

/* Default Kusto streaming inserts oauth scope (AzureCloud) */
...
#define FLB_AZURE_LOGIN_HOST_GERMAN         "login.microsoftonline.de"
...
#define FLB_AZURE_KUSTO_SCOPE_GERMAN         "https://help.kusto.cloudapi.de/.default"
...
#define FLB_AZURE_KUSTO_RESOURCE_GERMAN         "https://api.kusto.cloudapi.de/"
